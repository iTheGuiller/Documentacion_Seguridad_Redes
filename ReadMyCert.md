...
Se utilizo el comando para que nos arrojara la informacion donde contenia la bandera:


guillermo@MacBook-Pro-de-Guillermo PICO % openssl req -in readmycert.csr -text
